...
set Includes= /I "../" /I "B:/frameworks/SDL2-2.28.4/include" /I "B:/frameworks/SDL2_ttf-2.20.2/include" /I "B:\frameworks\SDL2_mixer-2.8.0\include" /I "B:\frameworks\SDL2_image-2.6.3\include" /I "../vendor/imgui" /I "../vendor/imgui/backends" /I "B:\frameworks\glew-2.1.0\include" /I "B:\frameworks\glm-0.9.9.8\includes"
set Libraries= SDL2main.lib SDL2.lib SDL2_image.lib SDL2_ttf.lib SDL2_mixer.lib
set LinkerFlags= /DEBUG -incremental:no /LIBPATH:B:\frameworks\glew-2.1.0\lib\Release\x64 -incremental:no winmm.lib user32.lib gdi32.lib opengl32.lib glew32.lib %Libraries%
